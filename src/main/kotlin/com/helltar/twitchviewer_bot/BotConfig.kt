...
object BotConfig {
    ...
    private const val DIR_SCRIPTS = "scripts/"
    ...
    const val SH_YTDLP_FFMPEG = DIR_SCRIPTS + "yt_dlp_ffmpeg.sh"
    const val SH_FFMPEG_SCREENSHOT = DIR_SCRIPTS + "ffmpeg_screenshot.sh"

    const val FILE_FFMPEG_OUT_VIDEO = DIR_TEMP + "out_%s.mp4"
    const val FILE_FFMPEG_OUT_IMAGE = DIR_TEMP + "out_%s.jpg"
